...
const nestSubMenu = (
  ...
  >
    ...
    <SubMenu
      ...
      arrowIcon={getSvgIcon()}
    >
      <SubMenu title="sub 4-2-0" key="4-2-0" arrowIcon={getSvgIcon()}>
        <MenuItem key="4-2-0-1">inner inner</MenuItem>
        <MenuItem key="4-2-0-2">inner inner2</MenuItem>
      </SubMenu>
      <MenuItem key="4-2-1">inn</MenuItem>
      <SubMenu title={<span>sub menu 4</span>} key="4-2-2" arrowIcon={getSvgIcon()}>
        <MenuItem key="4-2-2-1">inner inner</MenuItem>
        <MenuItem key="4-2-2-2">inner inner2</MenuItem>
      </SubMenu>
      <SubMenu title="sub 4-2-3" key="4-2-3" arrowIcon={getSvgIcon()}>
...
const commonMenu = (<Menu onClick={handleClick} onOpenChange={onOpenChange}>
  <SubMenu title={<span>sub menu</span>} key="1" arrowIcon={getSvgIcon()}>
